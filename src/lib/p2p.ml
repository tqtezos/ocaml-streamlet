...
let block_0 = mk_test_block "invalid hash TBD" 0 Helpers.get_test_txs "block_0_hash_tbd"

let block_1 = mk_test_block "block_0_hash_tbd" 1 Helpers.get_test_txs "block_1_hash_tbd"

let block_2 = mk_test_block "block_1_hash_tbd" 2 Helpers.get_test_txs "block_2_hash_tbd"
